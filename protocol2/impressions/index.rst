...
.. container:: protocol
    ...
    * :ref:`Supply-Side Platform <protocol-definitions-ssp>` redirects the event notification call to its :ref:`Context Platform <protocol-definitions-cp>`.
    * In response to the event notification call, :ref:`Context Platform <protocol-definitions-cp>` returns its :ref:`Context Script <protocol-definitions-contextscript>`, and :ref:`Supply-Side Agent <protocol-definitions-ssa>` makes an attempt to execute this script within its sandbox.
...
.. container:: protocol
    ...
    * Prior to generating the requested list, :ref:`Supply-Side Platform <protocol-definitions-ssp>` might need to call :ref:`Context Infrastructure <protocol-definitions-contextinfrastructure>` to retrieve :ref:`Context Data <protocol-definitions-contextdata>`.
...
.. note::
    The list of :ref:`Creatives <protocol-definitions-creative>` is generated by :ref:`Supply-Side Platform <protocol-definitions-ssp>` using information already cached there, without engaging any of the :ref:`DSPs <protocol-definitions-dsp>`. This is possible due to the fact that :ref:`Supply-Side Platform <protocol-definitions-ssp>` has already retrieved all the relevant :ref:`Demand-Side Inventories <protocol-definitions-demandinventory>` during the synchronization stage.
...
.. container:: protocol
    ...
    * :ref:`Supply-Side Platform <protocol-definitions-ssp>` redirects the event notification call to :ref:`Demand-Side Platform <protocol-definitions-dsp>`.
    * In response to the event notification call, :ref:`Demand-Side Platform <protocol-definitions-dsp>` returns an endpoint to its :ref:`Context Platform <protocol-definitions-cp>`.
    * Using the above endpoint, :ref:`Supply-Side Agent <protocol-definitions-ssa>` notifies :ref:`Context Platform <protocol-definitions-cp>` about :ref:`Register Event <protocol-definitions-registerevent>`.
    * In response to the event notification call, :ref:`Context Platform <protocol-definitions-cp>` returns its :ref:`Context Script <protocol-definitions-contextscript>`, and :ref:`Supply-Side Agent <protocol-definitions-ssa>` makes an attempt to execute this script within its sandbox.
...
.. container:: protocol
    ...
    * Optionally, :ref:`Demand-Side Agent <protocol-definitions-dsa>` responds to :ref:`Demand-Side Platform <protocol-definitions-dsp>` to notify it about :ref:`Conversion Event <protocol-definitions-conversionevent>`.
